const segment1info = {
  header: `Combining a passion for design with `,
  header2: `a drive for results.`,
...
export {
  segment5info as info5,
  segment4info as info4,
  segment1info as info1,
  segment2info as info2,
};
